        ...
        <div class="w-96 p-6 shadow-lg rounded-md bg-white border ">
            ...
            action="signup.php" method="POST" >
                ...
                <div class="underline self-center text-pink-700">
                    <h1 class="self-center text-[4rem] bg-gradient-to-br from-pink-400 to-pink-800 text-transparent bg-clip-text py-6">Register</h1>
                </div>
                
                <label class="block">
                    <span class="mt-6 block text-sm font-medium text-slate-700">Username</span>
                    <!-- Using form state modifiers, the classes can be identical for every input -->
                    <input type="text" placeholder="Username" name="username" required class="mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
                    ...
                    <!-- Using form state modifiers, the classes can be identical for every input -->
                    <input type="email" placeholder="Your Email" name="email" required class="mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
                    focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500
                    required:bg-slate-50 required:text-slate-500 required:border-slate-200 required:shadow-none
                    invalid:border-pink-500 invalid:text-sky-600
                    focus:invalid:border-sky-500 focus:invalid:ring-sky-500
                ...
                <div class="self-center">
                    <div class="mt-5 w-[8rem]">
                        <button name="btnsignup" class="from-pink-400 to-pink-800 text-white bg-gradient-to-br rounded-md text-sm text-pink-800 shadow-lg py-1 w-full font-semibold hover:bg-transparent">Sign Up</button>
                    </div>
                </div>
            </form>
        </div>
